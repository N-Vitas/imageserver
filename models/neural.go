 ...
 */
func (self *LearningNeural) Create(db *SessionDb,limit int)  {
...
func (self *LearningNeural) SaveNeuralDump(db *SessionDb,limit int) {
	if db == nil{
		return
	}
	id := int64(0)
...
// Создание новой записи
func (self *LearningNeural) LoadNeuralDump(db *SessionDb,limit int) bool {
	if db == nil {
		return false
	}
	weights := ""
...
func (self *LearningNeural) Execute(in []float64) []float64 {
	return self.Neural.Forward(in)
}
// Запрос погрешности нейронной сети
func (self *LearningNeural) HasError() []float64 {
	return self.Neural.ErrOutput
}
// Обучение нейронной сети
func (self *LearningNeural) Learning(inputs [][]float64,out [][]float64,iteration int) {
	if iteration == 0 {
		iteration = 10000
	}
